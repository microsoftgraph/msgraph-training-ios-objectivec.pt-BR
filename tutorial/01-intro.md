...
> [!NOTE]
> Este tutorial foi escrito usando o Xcode versão 11,4 e o CocoaPods versão 1.9.1. As etapas deste guia podem funcionar com outras versões, mas que não foram testadas.
